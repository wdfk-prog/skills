...
This guide provides comprehensive documentation for the **cpp-basics** skill in the custom-plugin-cpp plugin.
...
```bash
# Invoke the skill
claude "cpp-basics - [your task description]"

# Example
claude "cpp-basics - analyze the current implementation"
```
...
def implement_cpp_basics(input_data):
    """
    Implement cpp-basics functionality.
