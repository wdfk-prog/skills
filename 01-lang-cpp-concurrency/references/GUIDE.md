...
This guide provides comprehensive documentation for the **concurrency** skill in the custom-plugin-cpp plugin.
...
```bash
# Invoke the skill
claude "concurrency - [your task description]"

# Example
claude "concurrency - analyze the current implementation"
```
...
def implement_concurrency(input_data):
    """
    Implement concurrency functionality.
