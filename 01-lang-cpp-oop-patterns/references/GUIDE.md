...
This guide provides comprehensive documentation for the **oop-patterns** skill in the custom-plugin-cpp plugin.
...
```bash
# Invoke the skill
claude "oop-patterns - [your task description]"

# Example
claude "oop-patterns - analyze the current implementation"
```
...
def implement_oop_patterns(input_data):
    """
    Implement oop-patterns functionality.
