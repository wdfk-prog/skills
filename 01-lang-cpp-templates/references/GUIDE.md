...
This guide provides comprehensive documentation for the **templates** skill in the custom-plugin-cpp plugin.
...
```bash
# Invoke the skill
claude "templates - [your task description]"

# Example
claude "templates - analyze the current implementation"
```
...
def implement_templates(input_data):
    """
