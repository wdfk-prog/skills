---
name: 04-process-debugging-strategies
description: 用于系统化排障与根因分析（定位思路、复现/最小化、观测/假设验证、profiling）；当调查 bug、性能问题或异常行为时使用。
---
...
- 工具清单：调试器 / 日志 / profiler / tracing / 崩溃转储
- 检查清单：复现条件、最近变更、对照组、最小复现、验证修复
- 线上排障：先止血（开关/降级/回滚）→ 再定位根因（观测数据）
